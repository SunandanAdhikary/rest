...
public class ApiConfig {
	...
	public static String URL_DEPARTMENT_SEARCH;
	...
	URL_EMP_SEARCH=URL_HOST+"/resto/api/employees/";
	...
	URL_DEPARTMENT_SEARCH=URL_HOST+"/resto/api/corporation/departments/search?";
	...
	public static String makeURL_INVENTORY_BALANCE(String forDateTime,String deptGUID) {
	...
	public static String makeURL_PARAM_SEARCH(String url,String filterField,String filterValue) {
		url=url+filterField+"="+filterValue+"&key=";
		return url;
	}

	/**
	 * 
	 * @param filterFieldStartsWithCapital
	 * @param filterValue
	 * @return employee search by field url
	 */
	public static String makeURL_EMP_SEARCH(String filterFieldStartsWithCapital,String filterValue) {
		String url= URL_EMP_SEARCH;
		url=url+"/by"+filterFieldStartsWithCapital+"/"+filterValue+"&key=";
		return url;
	}
	 ...
	 */
	public static String makeURL_SUPPLIER_PRICELIST(String forSupplierCode) {
