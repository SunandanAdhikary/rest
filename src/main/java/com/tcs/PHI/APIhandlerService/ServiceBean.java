	...
	*/
	...
	private String logIn() {
		...
		log.debug("logged in .");
			...
			log.debug("Already logged in .Let's start .");
		return this.token;
	}
	/**
	 ...
	 */
	@Bean
	public Object fetchJsonFromUnnamedGetResponse(String urlWithouttoken){
		logIn();
		String url= urlWithouttoken+this.token;
	...
	/**
	 * use this when fetching all results/searching among all results in iiko
	 * @param urlWithoutToken
	 * @param filter
	 * @return
	 */
	public Object fetchFilteredXmlFromGetResponse(String urlWithoutToken, String filter){
		Object o=this.fetchXmlFromGetResponse(urlWithoutToken).get(filter);
